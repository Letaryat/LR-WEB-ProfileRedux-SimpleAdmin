...
<div class="row pad_5">
	...
	<div class="profile_head" <?php if(!empty($Vips)){echo 'id="active-vip"';}?>>
		<div class="profile_user_middle_block">
			<div class="profile_head_user_stats">
				<div class="profile_user_rank_block">
					...
					<img class="profile_head_user_rank" src="<?= $General->arr_general['site'] ?>storage/cache/img/ranks/<?= $Player->found[$Player->server_group]['ranks_pack'] . '/' . $Player->get_rank() ?>.png" alt="" title="" data-tippy-content="<?= $Translate->get_translate_module_phrase('module_page_profiles', '_Rank'); ?>" data-tippy-placement="top">
				</div>
		...
		<div class="profile_user_avatar">
			...
			<a href="//steamcommunity.com/profiles/<?= $Player->get_steam_64() ?>/" target="_blank">
				...
				<img class="" data-src="<?= $General->getAvatar($Player->get_steam_64(), 1) ?>" id="<?php $General->arr_general['avatars'] == 1 && print $Player->get_steam_64() ?>" alt="" title="">
			</a>
			<div class="profile_user_status <?php ($Player->Online($Player->get_steam_32_short()) > 0) ? print 'status_online' : print 'status_offline'; ?>">
				<svg viewBox="0 0 512 512">
