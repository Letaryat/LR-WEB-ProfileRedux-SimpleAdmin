				...
				<?php else : ?>
					...
					<ul class="bans_comms_list_body bans_comms_list_scroll no-scrollbar">
						<?php for ($i = 0, $c_c = min(sizeof($SBBans), 10); $i < $c_c; $i++) { ?>
							<li class="hover_lbam">
								<span class="bans_comms_none"><?= $SBBans[$i]['created'] ?></span>
						...
						<?php for ($i = 0, $c_c = min(sizeof($SBComms), 10); $i < $c_c; $i++) { ?>
							<li class="hover_lbam">
								<span class="bans_comms_none">
									...
									} elseif ($SBComms[$i]['type'] == "GAG") {
										echo '<svg viewBox="0 0 640 512"><path d="M64.03 239.1c0 49.59 21.38 94.1 56.97 130.7c-12.5 50.39-54.31 95.3-54.81 95.8c-2.187 2.297-2.781 5.703-1.5 8.703c1.312 3 4.125 4.797 7.312 4.797c66.31 0 116-31.8 140.6-51.41c32.72 12.31 69.02 19.41 107.4 19.41c37.39 0 72.78-6.663 104.8-18.36L82.93 161.7C70.81 185.9 64.03 212.3 64.03 239.1zM630.8 469.1l-118.1-92.59C551.1 340 576 292.4 576 240c0-114.9-114.6-207.1-255.1-207.1c-67.74 0-129.1 21.55-174.9 56.47L38.81 5.117C28.21-3.154 13.16-1.096 5.115 9.19C-3.072 19.63-1.249 34.72 9.188 42.89l591.1 463.1c10.5 8.203 25.57 6.333 33.7-4.073C643.1 492.4 641.2 477.3 630.8 469.1z"/></svg>';
									} elseif ($SBComms[$i]['type'] == "SILENCE") {
										echo '<svg viewBox="0 0 512 512"><path d="M367.2 412.5L99.5 144.8C77.1 176.1 64 214.5 64 256c0 106 86 192 192 192c41.5 0 79.9-13.1 111.2-35.5zm45.3-45.3C434.9 335.9 448 297.5 448 256c0-106-86-192-192-192c-41.5 0-79.9 13.1-111.2 35.5L412.5 367.2zM512 256c0 141.4-114.6 256-256 256S0 397.4 0 256S114.6 0 256 0S512 114.6 512 256z"/></svg>';
									}
									?>
								</span>
								<span class="bans_comms_none"><?= $SBComms[$i]['created'] ?></span>
								<span><?= $SBComms[$i]['reason'] ?></span>
								<span class="bans_comms_none"><a href="<?= $General->arr_general['site'] ?>profiles/<?= $SBComms[$i]['admin_steamid'] ?>/?search=1"><?= $SBComms[$i]['admin_name'] ?></a></span>
								<span>
									<?php
